...
it appears in the Matlab editor. In this respect, it arguably does a much better
job than the other available options (minted, listings, mcode, etc.) do.
...
It also defines macro for typesetting placeholders in code snippets. Altought it
doesn't support Unicode, it is compatible with XeLaTeX and LuaLaTeX.
